 ...
 * 
 */
public class ImageBuilderCombo extends Algorithm {
	...
	public void launch() throws AlgorithmException {
		...
		d2d = new DrawConceptCombo(inputImage, filename, displayImage);
	...
	public static Image exec(int sizeX, int sizeY, String filename) {
		return (Image) new ImageBuilderCombo().process(new ByteImage(sizeX, sizeY,
				1, 1, 3), filename);
	}
	...
	public static Image exec(Image inputImage, String filename) {
		return (Image) new ImageBuilderCombo().process(inputImage, filename);
	}
